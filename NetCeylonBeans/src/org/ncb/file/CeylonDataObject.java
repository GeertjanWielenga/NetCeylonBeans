...
@Messages({
    "LBL_Ceylon_LOADER=Files of Ceylon"
})
@MIMEResolver.ExtensionRegistration(
        displayName = "#LBL_Ceylon_LOADER",
        mimeType = "text/x-ceylon",
        extension = {"ceylon"}
)
@DataObject.Registration(
        mimeType = "text/x-ceylon",
        iconBase = "org/ncb/resources/ceylon_icon.png",
        displayName = "#LBL_Ceylon_LOADER",
        position = 300
)
@ActionReferences({
    @ActionReference(
            path = "Loaders/text/x-ceylon/Actions",
...
public class CeylonDataObject extends MultiDataObject {
    ...
    public CeylonDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        registerEditor("text/x-ceylon", false);
    }
